...
const MORE_SECTIONS = [
  ...
  },
  {
    id: 'scrLeaderboard',
    label: 'Лидерборд',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 9a6 6 0 0012 0V3H6v6z"/><path d="M12 15v4"/><path d="M8 22h8"/><path d="M15 19H9"/></svg>'
  },
  {
    id: 'scrReferrals',
    label: 'Рефералы',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><path d="M20 8v6"/><path d="M23 11h-6"/></svg>'
  },
  {
    id: 'scrSubscription',
    label: 'Подписка',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>'
  },
  {
    id: 'scrWallet',
    label: 'Кошелёк',
  ...
  },
  {
    id: 'scrNotifications',
    label: 'Уведомления',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>'
  },
  {
    id: 'scrForum',
    label: 'Форум',
