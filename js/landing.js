...
const TARIFF_DATA = {
  free: {
    ...
    content: '<div style="font-size:13.5px;line-height:1.75;color:rgba(255,255,255,0.65);">' +
      '<p style="margin-bottom:12px;">Бесплатный тариф — это полноценный вход в экосистему MLM Community. Без оплаты, без ограничений по времени.</p>' +
